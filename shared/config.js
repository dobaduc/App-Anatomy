var config = {
  tabData: {
    tab1: [
      '<h3>INTRODUCTION TO DHTINY</h3><br/>',
      ...
      '<br/><h3>THE IDEA OF WRITING A JAVASCRIPT LIBRARY FROM SCRATCH</h3><br/>',
      ...
      "<br>Finally, I decided to write a whole new little library from scratch, in order to be able to write JS code in the way that I like (short, flexible, and strong), and never care about the weight of it. After 1 months without any Sunday or Saturday, I've finished my library DHTiny while writing another project for the customer."+
